...
export default function Dashboard({ user, transactions, budgets }: Props) {
  const stats = useMemo(() => {
    ...
    return { income, expenses, net: income - expenses, totalBudget, totalSpent };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Here's your financial overview for this month.</p>
      </div>
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={chartData}>
              ...
              <Tooltip
                contentStyle={{ borderRadius: 12, border: "1px solid hsl(30 15% 89%)", fontSize: 13 }}
      ...
      <motion.div
        ...
        className="glass-card rounded-xl p-5"
      >
        <h2 className="font-serif text-lg mb-4">Recent Transactions</h2>
